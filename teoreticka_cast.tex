...
\klucoveslova{ekonometria, regresia, heteroskedasticita, autokorelácia, multikolinearita}
...
\keywords{econometrics, regression, heteroscedasticity, autocorrelation, multicollinearity}
...
\begin{figure}[!ht] 
    \centering 
    \includegraphics[scale = 0.45]{diplomka obrazky/15.png} 
    \caption{Neobmedzený, obmedzený a iba-priesečník model.} 
    \source{Zdroj: Prevzaté z [8].} 
\end{figure} 
...
\begin{enumerate}[label={[\arabic*]}]
    \item  STOCK, H. J., WATSON, M. Introduction to Econometrics. 4. vyd. Cambridge : Pearson, 2018. ISBN 0134461991.
    
    \item HEISS, F. Using R for Introductory Econometrics. 6. vyd. Düsseldorf : Heinrich Heine University of Düsseldorf, 2016. ISBN: 979-8648424364.
    
    \item STOCK, H. J., WATSON, M. Introduction to Econometrics. 4. vyd. Cambridge : Pearson, 2018. s. 146. ISBN 0134461991.
    
    \item GOLD, CH. Modeling of Take-Over Performance in Highly Automated Vehicle Guidance - Scientific Figure on ResearchGate. [online]. Dostupné na: <\url{https://www.researchgate.net/figure/Visualization-of-SSE-SSR-SST_fig17_322398615}>.
    
    \item PARK, T. P-Value and Statistical Significance for A/B Testing. 2016. [online]. Dostupné na: <https://www.marketing-mojo.com/blog/understanding-p-value-and-statistical-significance-for-ab-testing>.
    
    \item STOCK, H. J., WATSON, M. Introduction to Econometrics. 4. vyd. Cambridge : Pearson, 2018. s. 189. ISBN 0134461991.
    
    \item STOCK, H. J., WATSON, M. Introduction to Econometrics. 4. vyd. Cambridge : Pearson, 2018. s. 767. ISBN 0134461991.
    
    \item SACHIN, D. The F-Test for Regression Analysis. Wikimedia Commons : CC BY-SA 4.0, 2019. [online]. Dostupné na: <https://towardsdatascience.com/fisher-test-for-regression-analysis-1e1687867259>. 

    \item WIKIPEDIA. Matrix multiplication. [online]. Dostupné na: <\url{https://en.wikipedia.org/wiki/Matrix_multiplication}>.
    
    \item BLOGR. Visualising Residuals. 2016. [online]. Dostupné na: <\url{https://drsimonj.svbtle.com/visualising-residuals}>.
    
    \item Dogan, Nurhan & Dogan, Ismet. (2010). DETERMINATION OF THE NUMBER OF BINS/CLASSES USED IN HISTOGRAMS AND FREQUENCY TABLES: A SHORT BIBLIOGRAPHY. TurkStat, Journal of Statistical Research. 07. 77-86. 
    
    \item KREYZIG, E. Advanced Engineering Mathematics. 8. vyd. Wiley, 2011. ISBN 0471154962. [online] Dostupné na: <\url{http://hyperphysics.phy-astr.gsu.edu/hbase/Math/dice.html}>.
    
    \item BEVANS, E. T-distribution: What it is and how to use it. 2020. [online]. Dostupné na: <\url{https://www.scribbr.com/statistics/t-distribution/}>.
    
    \item WIKIPEDIA. Percentile. [online]. Dostupné na: <\url{https://en.wikipedia.org/wiki/Percentile}>.
    
    \item ONLINE.STAT.PSU.EDU. Residuals vs. Order Plot. [online]. Dostupné na: <\url{https://online.stat.psu.edu/stat501/book/export/html/915}>.
    
    \item R Core Team (2020). R: A language and environment
  for statistical computing. R Foundation for
  Statistical Computing, Vienna, Austria. [online]. Dostupné na: <\url{ https://www.R-project.org/}>.
    
    \item RStudio Team (2020). RStudio: Integrated
  Development Environment for R. RStudio, PBC,
  Boston, MA. [online]. Dostupné na: <\url{https://www.rstudio.com/}>.
    
    \item GROLEMUND, G., WICKHAM. H. Hands-On Programming with R: Write Your Own Functions and Simulations. O'Reilly Media, 2014. ISBN 9781449359010.[online]. Dostupné na: <\url{https://rstudio-education.github.io/hopr/}>.
    
    \item JOSHUA D. Angrist, Jörn-Steffen Pischke.
            "Mastering ’Metrics: The Path from Cause to Effect," Economics Books. Princeton University Press. 1. vyd. označenie 10363. Október, 2014. ISBN 9781400852383.
    
    \item JOSHUA D. Angrist & Jörn-Steffen Pischke. "Mostly Harmless Econometrics: An Empiricist's Companion," Economics Books, Princeton University Press. 1. vyd. označenie 8769. Október. 2009. ISBN 0691120358.
    
    \item LAMBERT, B. Youtube. [online]. Dostupné na: <\url{https://www.youtube.com/channel/UC3tFZR3eL1bDY8CqZDOQh-w}>.
    
    \item WOOLDRIDGE, J. M. Introductory Econometrics: A Modern Approach. 6. vyd. Michigan : Cengage Learning, 2015. ISBN 130527010X.
    
    \item OVERLEAF. online LaTex editor. [online]. Dostupné na: <\url{https://www.overleaf.com/}>.
    
    \item HANCK, CH. a kol. Introduction to Econometrics with R. Essen, Germany : University of Duisburg-Essen, 2019. [online]. Dostupné na: <\url{https://www.econometrics-with-r.org/}>.
    
    \item Yihui Xie (2014) knitr: A Comprehensive Tool for
  ...
  Chapman and Hall/CRC. ISBN 978-1466561595.
    ...
    \item Yihui Xie and J.J. Allaire and Garrett Grolemund
  (2018). R Markdown: The Definitive Guide. Chapman
  and Hall/CRC. ISBN 9781138359338. Dostupné na: <\url{https://bookdown.org/yihui/rmarkdown}>.
    
    \item ZEDSTATISTICS. Youtube. [online]. Dostupné na: <\url{https://www.youtube.com/c/zedstatistics/}>.
    
    \item MRNYSTROM. Youtube. [online]. Dostupné na: <\url{https://youtube.com/user/MrNystrom/}>.
    
    \item JBSTASTISTICS. Youtube. [online]. Dostupné na: <\url{https://youtube.com/user/jbstatistics/}>.
